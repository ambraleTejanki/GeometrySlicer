...
function createCube(): MeshGeometry {
  ...
  return compactGeometry(p, i);  // calculates the lighting normals
}

/*
 @param segments = horizontal slices
 ring = vertical slices
  uses phi for vertical angle and theta  for horizontal angle.
*/
...
/*
tube: it uses Math.cos(a) and Math.sin(a) to place points in a circle at heights
caps: it adds two extra points: one at the very center of the bottom (0, -1, 0) and one at the top (0, 1, 0)
*/
